...
const tools = [
  ...
  { href: '/ideal-weight', label: 'Ideal Weight' },
  { href: '/one-rep-max', label: 'One Rep Max' },
  { href: '/running-pace', label: 'Running Pace' },
...
export default function CalcNav() {
  ...
  const toggleDark = () => {
    ...
    try { localStorage.setItem('fitnesscalculators-theme', next ? 'dark' : 'light') } catch { /* ignore */ }
  }

  return (
    <nav aria-label="Fitness calculator navigation" className="px-4 sm:px-6 overflow-x-auto">
